...
export const home = {
  ...
  genesis: {
    ...
    cta: "지금 자리 잡기",
    note: "선착순 500대. 이메일과 차량 정보만 받고, 위치나 차대번호는 받지 않습니다.",
  },

  density: {
    title: "지금, 어디에 몇 명",
    sub: "등록이 확정된 좌석의 지역 분포입니다. 좌표가 아니라 본인이 고른 광역권입니다.",
    note: "실제 지도가 아니라 도식입니다. 등록자는 좌표를 남기지 않으며, 이 그림이 말할 수 있는 것은 권역별 인원수뿐입니다. 리그는 아는 얼굴이 있어야 돌고 상환처는 생활권에 있어야 쓰이므로, 총계보다 이 분포가 중요합니다.",
  },
