/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.jsonc cloudflare/worker-configuration.d.ts` (hash: d482c956e36e5c1a44c5fcb6f4ff7eb3)
// Runtime types generated with workerd@1.20260804.1 2026-08-11 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ALLOWED_ORIGINS: "http://localhost:3000" | "https://teslam.io";
	SITE_ORIGIN: "http://localhost:3000" | "https://teslam.io";
	LIVE: DurableObjectNamespace<import("./worker").LiveBoard>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "SITE_ORIGIN">> {}
}
