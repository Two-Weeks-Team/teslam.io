...
> **Source** <https://developer.tesla.com/docs/fleet-api/endpoints/partner-endpoints>  
...
Returns a list of vins that have fleet telemetry errors reported after receiving the config.
