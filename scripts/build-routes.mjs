...
const TRIPS = [
  { id: "seoul-gangneung", ko: "서울 → 강릉", en: "Seoul → Gangneung",
    note: { ko: "영동고속도로", en: "Yeongdong Expressway" },
    from: [127.0276, 37.4979], to: [128.8961, 37.7519] },
  { id: "pangyo-giheung", ko: "판교 → 기흥", en: "Pangyo → Giheung",
    note: { ko: "경부고속도로 · 슈퍼차저", en: "Gyeongbu Expressway · Supercharger" },
    from: [127.1119, 37.3947], to: [127.1157, 37.2751] },
  { id: "busan-coast", ko: "해운대 → 광안리", en: "Haeundae → Gwangalli",
    note: { ko: "광안대교", en: "Gwangan Bridge" },
    from: [129.1603, 35.1587], to: [129.1188, 35.1532] },
  { id: "jeju-coast", ko: "제주시 → 성산", en: "Jeju City → Seongsan",
    note: { ko: "일주동로", en: "Coastal road" },
    from: [126.5219, 33.5097], to: [126.9269, 33.4589] },
  { id: "seoul-busan", ko: "서울 → 부산", en: "Seoul → Busan",
    note: { ko: "경부고속도로", en: "Gyeongbu Expressway" },
    from: [127.0276, 37.4979], to: [129.0756, 35.1796] },
  { id: "seoul-daejeon", ko: "서울 → 대전", en: "Seoul → Daejeon",
    note: { ko: "경부선", en: "Gyeongbu corridor" },
    from: [126.9780, 37.5665], to: [127.3845, 36.3504] },
  { id: "daegu-pohang", ko: "대구 → 포항", en: "Daegu → Pohang",
    note: { ko: "대구포항고속도로", en: "Daegu–Pohang Expressway" },
    from: [128.6014, 35.8714], to: [129.3435, 36.0190] },
  { id: "gwangju-yeosu", ko: "광주 → 여수", en: "Gwangju → Yeosu",
    note: { ko: "남해안", en: "South coast" },
    from: [126.8526, 35.1595], to: [127.6622, 34.7604] },
  { id: "incheon-suwon", ko: "인천 → 수원", en: "Incheon → Suwon",
    note: { ko: "수도권 외곽", en: "Capital ring" },
    from: [126.7052, 37.4563], to: [127.0286, 37.2636] },
  { id: "wonju-chuncheon", ko: "원주 → 춘천", en: "Wonju → Chuncheon",
    note: { ko: "중앙고속도로", en: "Jungang Expressway" },
    from: [127.9202, 37.3422], to: [127.7295, 37.8813] },
  { id: "jeonju-gunsan", ko: "전주 → 군산", en: "Jeonju → Gunsan",
    note: { ko: "호남 서부", en: "Western Honam" },
    from: [127.1480, 35.8242], to: [126.7370, 35.9676] },
  { id: "ulsan-gyeongju", ko: "울산 → 경주", en: "Ulsan → Gyeongju",
    note: { ko: "동해선", en: "East coast" },
    from: [129.3114, 35.5384], to: [129.2247, 35.8562] },
];
